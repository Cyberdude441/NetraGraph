    ...
    <div className="rounded-lg border border-[#E2E8F0] bg-white p-5 text-xs select-none space-y-4 font-sans shadow-2xl">
      ...
      <div className="grid grid-cols-3 gap-3 font-mono text-[11px]">
        <div className="rounded border border-[#E2E8F0] bg-white p-2.5">
          ...
          <span className="text-base font-bold text-slate-800">{burst.baselineDailyAvg} Calls</span>
        </div>
        <div className="rounded border border-[#E2E8F0] bg-white p-2.5">
        ...
        <div className="rounded border border-[#E2E8F0] bg-white p-2.5">
          ...
          <span className="text-base font-bold text-emerald-400">{burst.targetEntities.length} Entities</span>
        </div>
      </div>

      {/* Recharts Call Volume Bar Chart */}
      <div className="rounded-lg border border-[#E2E8F0] bg-white p-3 space-y-2">
        <div className="flex items-center justify-between text-[10px] font-mono text-slate-400 border-b border-[#E2E8F0]/80 pb-1.5">
