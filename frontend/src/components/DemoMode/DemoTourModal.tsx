...
export function DemoTourModal({ isOpen, onClose }: DemoTourModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-4 select-none font-sans">
      <div className="w-full max-w-2xl rounded-xl border border-[#E2E8F0] bg-white p-6 shadow-2xl space-y-5">
        {/* Top Header */}
        <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-3">
          <div className="flex items-center gap-2.5">
            <span className="flex size-8 items-center justify-center rounded-lg bg-emerald-950/60 border border-emerald-800 text-emerald-300">
        ...
        <div className="rounded-lg border border-[#E2E8F0] bg-white p-5 space-y-4">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2.5">
              <span className="flex size-9 items-center justify-center rounded-lg bg-[#F8FAFC] border border-slate-300 text-emerald-400">
              ...
              <div>
                ...
                <span className="rounded bg-emerald-950/60 border border-emerald-800 px-2 py-0.2 text-[9px] font-mono font-bold text-emerald-300">
                  {currentStep.badge}
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 font-mono text-[11px]">
            <div className="rounded bg-[#F8FAFC] p-3 border border-[#E2E8F0] space-y-1">
              <span className="text-[9px] uppercase font-bold text-amber-400 block">
                Investigator Action:
              </span>
              <p className="text-slate-700 font-sans text-xs leading-tight">
        ...
        <div className="flex items-center justify-between border-t border-[#E2E8F0] pt-3">
          <button
            ...
            className={cn(
              ...
              currentStepIdx > 0
                ? "bg-[#F8FAFC] border border-[#E2E8F0] text-slate-700 hover:text-white cursor-pointer"
