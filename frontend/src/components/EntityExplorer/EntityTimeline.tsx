...
export function EntityTimeline({ timeline, entityName }: EntityTimelineProps) {
  ...
  return (
    <div className="rounded border border-[#E2E8F0] bg-white p-4 text-xs select-none space-y-4 font-sans">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#E2E8F0] pb-3">
        ...
        {/* Filter Pills */}
        <div className="flex flex-wrap items-center gap-1 bg-[#F8FAFC] p-1 rounded border border-[#E2E8F0] font-mono text-[10px]">
          {(
            [
            ...
            return (
              <div key={evt.id || idx} className="relative group">
                ...
                >
                  ...
                  <div className="mt-2 flex items-center justify-between border-t border-[#E2E8F0]/80 pt-1.5 text-[10px] font-mono text-slate-500">
                    <span>Source Reference: <strong className="text-slate-700">{evt.sourceRef}</strong></span>
