...
export function LocationPanel({
  ...
  if (!location) {
    return (
      <div className="rounded-lg border border-dashed border-[#E2E8F0] bg-white p-10 text-center text-slate-500 font-mono text-xs">
    ...
    <div className="rounded-lg border border-[#E2E8F0] bg-white p-5 text-xs select-none space-y-4 font-sans shadow-2xl">
      ...
      <div className="grid grid-cols-2 gap-2 font-mono text-[11px]">
        <div className="rounded bg-white p-2.5 border border-[#E2E8F0]">
          ...
          <strong className="text-emerald-300 text-xs">{location.latitude}, {location.longitude}</strong>
        </div>
        <div className="rounded bg-white p-2.5 border border-[#E2E8F0]">
      ...
      <div className="rounded border border-[#E2E8F0] bg-white p-3 space-y-1">
      ...
      <div className="rounded border border-[#E2E8F0] bg-white p-3 space-y-2">
        <span className="text-[10px] font-mono uppercase font-bold text-slate-700 flex items-center justify-between">
        ...
        <div className="flex flex-wrap gap-1.5 font-mono text-[10px]">
          {location.connectedEntityIds.map((eId) => (
            <button
              ...
              className="rounded bg-[#F8FAFC] px-2 py-1 text-slate-800 border border-[#E2E8F0] hover:border-emerald-500 hover:text-emerald-300 transition-colors cursor-pointer font-bold"
            >
              {eId}
            </button>
          ))}
      ...
      <div className="rounded border border-emerald-900/40 bg-emerald-950/20 p-3 space-y-1 font-mono text-[10px]">
