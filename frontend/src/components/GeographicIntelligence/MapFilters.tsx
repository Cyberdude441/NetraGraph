    ...
    <div className="space-y-4 text-xs select-none font-sans">
      ...
      <div className="rounded border border-[#E2E8F0]/80 bg-white p-3 space-y-2">
        <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
          <Eye className="size-3 text-emerald-400" /> Tactical Layer Controls
        </label>
      ...
      {/* 2. City Hub Selector */}
      <div className="rounded border border-[#E2E8F0]/80 bg-white p-3 space-y-1.5">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? "border-emerald-500/50 bg-emerald-50 text-emerald-200 font-bold"
                    : "border-[#E2E8F0] bg-[#F8FAFC] text-slate-500"
                )}
              >
                {t.label}
