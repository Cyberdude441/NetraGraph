...
export function GraphFilters({
  ...
  return (
    <aside className="w-72 shrink-0 border-r border-[#E2E8F0] bg-white flex flex-col h-full overflow-hidden select-none 2xl:w-80">
      {/* Header */}
      <div className="border-b border-[#E2E8F0] bg-[#F8FAFC] px-4 py-3 flex items-center justify-between">
        ...
        <button
          onClick={onReset}
          className="flex items-center gap-1 text-[10px] font-mono text-slate-400 hover:text-emerald-400 transition-colors cursor-pointer"
      ...
      {/* Filter Stats HUD */}
      <div className="bg-[#F8FAFC] px-4 py-2 border-b border-[#E2E8F0]/80 flex items-center justify-between text-[11px] font-mono">
      ...
      {/* Filter Body */}
      <div className="flex-1 overflow-y-auto p-3.5 space-y-4 text-xs text-slate-700 custom-scrollbar">
        ...
        <div className="space-y-1.5">
          <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
            <Search className="size-3 text-emerald-400" /> Search Keyword / ID
          </label>
          <div className="relative">
            <input
              ...
              className="w-full rounded border border-[#E2E8F0] bg-[#F8FAFC] px-2.5 py-1.5 text-xs text-slate-800 placeholder:text-slate-500 outline-none focus:border-emerald-500 font-mono"
            />
          </div>
        </div>

        {/* 2. Entity Type Matrix */}
        <div className="space-y-2 rounded border border-[#E2E8F0]/80 bg-white p-2.5">
          <div className="flex items-center justify-between">
            <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
              <Layers className="size-3 text-emerald-400" /> Entity Classification
            </label>
            <button
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {ALL_ENTITY_TYPES.map((type) => {
              ...
              return (
                ...
                >
                  <Icon className={cn("size-3", active ? "text-emerald-400" : "text-slate-600")} />
        ...
        <div className="space-y-2.5 rounded border border-[#E2E8F0]/80 bg-white p-2.5">
          <div className="flex items-center justify-between">
            <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
          ...
          <div className="grid grid-cols-4 gap-1">
            {[
              ...
              { id: "medium", label: "Med", color: "text-slate-700 border-slate-600 bg-slate-100/30" },
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? r.color
                      : "border-[#E2E8F0] bg-[#F8FAFC] text-slate-600 hover:border-slate-300"
                  )}
                >
                  {r.label}
                </button>
        ...
        <div className="space-y-2 rounded border border-[#E2E8F0]/80 bg-white p-2.5">
          <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
            <FolderSearch className="size-3 text-emerald-400" /> Case Docket Filter
          </label>
          <select
            ...
            className="w-full rounded border border-[#E2E8F0] bg-[#F8FAFC] px-2 py-1.5 text-xs text-emerald-300 font-mono outline-none"
          >
          ...
          <select
            ...
            className="w-full rounded border border-[#E2E8F0] bg-[#F8FAFC] px-2 py-1.5 text-xs text-slate-800 font-mono outline-none"
          >
        ...
        <div className="space-y-2 rounded border border-[#E2E8F0]/80 bg-white p-2.5">
          <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
            <Calendar className="size-3 text-emerald-400" /> Temporal Range
          </label>
          ...
          <div className="space-y-1.5 font-mono text-[10px]">
            <div className="flex items-center justify-between gap-2">
              ...
              <input
                ...
                className="rounded border border-[#E2E8F0] bg-[#F8FAFC] px-1.5 py-0.5 text-slate-800 outline-none text-[10px]"
              />
            </div>
            <div className="flex items-center justify-between gap-2">
        ...
        <div className="space-y-1.5 rounded border border-[#E2E8F0]/80 bg-white p-2.5">
          <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
            <ArrowRightLeft className="size-3 text-emerald-400" /> Link Modalities ({stats.matchedRelationships} links)
          </label>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "border-emerald-500/40 bg-emerald-50 text-emerald-300"
