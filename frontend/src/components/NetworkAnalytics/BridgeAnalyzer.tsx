      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        {topBridges.map((bridge) => (
          <div
            ...
            className="rounded-lg border border-[#E2E8F0] bg-white p-3.5 space-y-3 hover:border-emerald-500/60 transition-all cursor-pointer"
          >
            ...
            <div className="rounded border border-[#E2E8F0]/80 bg-[#F8FAFC] p-2.5 space-y-1">
              ...
              <p className="text-[11px] text-slate-700 leading-tight font-sans">
                {bridge.explanation}
              </p>
            </div>

            {/* Metrics */}
            <div className="grid grid-cols-3 gap-2 border-t border-[#E2E8F0]/80 pt-2 font-mono text-[10px] text-slate-400">
              <div>
                <span className="text-slate-500">Degree: </span>
                <strong className="text-slate-800">{bridge.degree} Links</strong>
              </div>
              <div>
                <span className="text-slate-500">PageRank: </span>
                <strong className="text-emerald-300">{bridge.pageRank}%</strong>
              </div>
              <div>
