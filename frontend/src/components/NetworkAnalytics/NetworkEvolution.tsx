  ...
  return (
    <div className="rounded-lg border border-[#E2E8F0] bg-white p-5 text-xs select-none space-y-4 font-sans shadow-2xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#E2E8F0] pb-3">
        ...
        {/* Timeframe Buttons */}
        <div className="flex items-center gap-1 rounded bg-[#F8FAFC] p-1 border border-[#E2E8F0] font-mono text-xs">
          {(
            [
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono">
        <div className="rounded border border-[#E2E8F0] bg-white p-3">
          ...
          <span className="text-[9px] text-emerald-400">In Selected Window</span>
        </div>
