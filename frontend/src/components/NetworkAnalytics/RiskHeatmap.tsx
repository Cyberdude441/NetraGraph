        ...
        {zones.map((z, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="space-y-1 font-mono text-[10px] text-slate-400 border-t border-[#E2E8F0]/80 pt-2">
                <div className="flex items-center justify-between">
                  <span>Syndicate Group:</span>
                  <span className="text-slate-800 truncate max-w-[170px]">{z.clusterGroup}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-slate-800">{z.criticalRiskCount} Entities</span>
                </div>
