...
export const CLUSTER_PALETTE = [
  "#10B981", // Green (Noida Tech Support Scam)
  "#F59E0B", // Amber / Gold (Bhubaneswar SIM Box Ring)
  "#DC2626", // Critical red (LockNet Ransomware Group)
  "#10B981", // Emerald (Inter-State Hawala Network)
  "#64748B", // Slate (Mule Ledger Syndicate Tier-2)
  "#94A3B8", // Light slate
];
...
export function analyzeCommunitiesAndModularity(
  ...
  clusterNames.forEach((name, cIdx) => {
    ...
    communities.push({
      id: cIdx,
      name,
      color: CLUSTER_PALETTE[cIdx % CLUSTER_PALETTE.length] || "#10B981",
