    ...
    <div className="space-y-4 text-xs select-none font-sans">
      ...
      <div className="rounded border border-slate-800/80 bg-[#121922] p-3 space-y-2">
        <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1">
          <Layers className="size-3 text-sky-400" /> Behavioral Pattern Category
        </label>
        ...
        <div className="space-y-1">
          {(Object.keys(CATEGORY_META) as AnomalyCategory[]).map((cat) => {
            ...
            return (
              ...
              >
                <Icon className={cn("size-3.5", active ? "text-sky-400" : "text-slate-600")} />
                ...
                className={cn(
                  ...
                  active
                    ? sev === "CRITICAL"
                      ...
                      : sev === "MEDIUM"
                      ? "bg-sky-950/60 text-sky-300 border-sky-500/60"
