        ...
        {loop.hops.map((hop, idx) => {
          ...
          return (
            <div key={idx} className="relative group">
              ...
              <div
                className={cn(
                  ...
                  isFirst
                    ...
                    : "border-slate-700 bg-[#161D24] text-slate-300"
                )}
              >
                {hop.hopIndex}
              </div>
              ...
              {/* Hop Transfer Card */}
              <div className="rounded-lg border border-slate-800 bg-[#121820] p-3 space-y-2 hover:border-purple-500/60 transition-all">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-800/80 pt-1.5 text-[10px] font-mono text-slate-500">
                  <span>Channel: <strong className="text-slate-300">{hop.channel}</strong></span>
