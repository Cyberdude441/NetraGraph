...
export function MergeWorkspace({
  ...
  return (
    <div className="rounded-lg border border-slate-800 bg-[#0E1318] p-5 text-xs select-none space-y-4 font-sans shadow-2xl">
      ...
      <div className="rounded border border-slate-800 bg-[#121820] p-3 flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
        <div className="flex items-center gap-2">
          <span className="rounded bg-slate-800 px-2 py-0.5 text-slate-300 font-bold">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isPrimary
                    ? "border-sky-500 bg-[#152230] shadow-md ring-1 ring-sky-400/50"
                    : "border-slate-800 bg-[#10161E] hover:border-slate-700"
                )}
              >
      ...
      <div className="rounded border border-slate-800 bg-[#121820] p-3 space-y-2 font-mono text-[11px]">
        ...
        <div className="space-y-1.5 text-slate-300">
          <div className="flex items-center justify-between border-b border-slate-800/80 pb-1">
            ...
            <strong className="text-slate-100">{primary.name}</strong>
          </div>
      ...
      <div className="space-y-2 rounded border border-slate-800 bg-[#121820] p-3">
        <label className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-bold block">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded border border-slate-800 bg-[#161D24] px-2.5 py-1 text-xs text-slate-200 font-mono outline-none focus:border-sky-500"
            />
          </div>
          <div>
            <span className="text-[9px] font-mono text-slate-500 block mb-1">
            ...
            <input
              ...
              className="w-full rounded border border-slate-800 bg-[#161D24] px-2.5 py-1 text-xs text-sky-300 font-mono outline-none"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded border border-slate-800 bg-[#161D24] p-2 text-xs text-slate-200 font-mono outline-none focus:border-sky-500"
          />
        </div>
      </div>
      ...
      <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-800">
        <button
          onClick={onCancel}
          className="rounded border border-slate-800 bg-[#161D24] px-3.5 py-1.5 text-xs font-mono text-slate-400 hover:text-slate-200 cursor-pointer"
        >
          Cancel
        </button>
        <button
