...
export function CentralityPanel({
  ...
  return (
    <div className="flex flex-col h-full bg-[#0E1318] border-t border-slate-800 text-xs select-none">
      {/* Tab Navigation Header */}
      <div className="flex items-center justify-between border-b border-slate-800 bg-[#141A21] px-4 py-2">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? "bg-[#1E293B] text-sky-300 border border-sky-500/40 shadow-xs"
        ...
        {sortedEntities.slice(0, 8).map((entity, idx) => {
          ...
          return (
            <div
              ...
              className={cn(
                "flex items-center justify-between gap-2.5 rounded border p-2.5 transition-all cursor-pointer hover:border-sky-500",
                isSelected
                  ? "border-sky-500/80 bg-[#16222F] shadow-md ring-1 ring-sky-400/40"
                  : "border-slate-800 bg-[#121820] hover:bg-[#161E28]"
              )}
            >
              {/* Rank Badge & Identity */}
                ...
                <span
                  className={cn(
                    ...
                    idx === 0
                      ...
                      : "bg-[#1A232E] text-slate-400 border border-slate-800"
                  )}
                >
                  #{idx + 1}
                </span>
