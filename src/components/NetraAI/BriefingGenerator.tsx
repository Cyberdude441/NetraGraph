...
export function BriefingGenerator({ caseId = "CASE-2026-N09", onClose }: BriefingGeneratorProps) {
  ...
  return (
    <div className="rounded-lg border border-slate-800 bg-[#0E1318] p-6 text-xs select-none space-y-5 font-sans shadow-2xl">
      {/* Top Action Header */}
      ...
      <div className="space-y-4 text-slate-300 font-sans">
        {/* Section 1: Overview */}
        <div className="rounded border border-slate-800 bg-[#121820] p-4 space-y-1.5">
          <h4 className="text-[11px] font-mono uppercase font-bold text-sky-400 flex items-center gap-1.5">
        ...
        <div className="rounded border border-slate-800 bg-[#121820] p-4 space-y-2">
          <h4 className="text-[11px] font-mono uppercase font-bold text-sky-400 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 font-mono text-[11px]">
            {briefing.sections.keyEntities.map((e) => (
              <div key={e.id} className="rounded bg-[#161D24] p-2.5 border border-slate-800 flex items-center justify-between">
                <div>
                  <strong className="text-slate-100 text-xs block">{e.name}</strong>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="rounded border border-slate-800 bg-[#121820] p-4 space-y-2 font-mono text-[11px]">
            <h4 className="text-[11px] uppercase font-bold text-sky-400">
              § 3. Network Topology
            </h4>
            <div className="space-y-1 text-slate-300">
              ...
              <div className="flex justify-between py-1">
                ...
                <strong className="text-sky-300">{briefing.sections.networkStructure.density}</strong>
              </div>
            </div>
          </div>

          <div className="rounded border border-slate-800 bg-[#121820] p-4 space-y-2">
            <h4 className="text-[11px] font-mono uppercase font-bold text-sky-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded border border-slate-800 bg-[#121820] p-3.5 space-y-1.5">
