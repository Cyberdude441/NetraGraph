      ...
      <div className="space-y-2 font-mono text-[11px]">
        {citations.map((cite) => (
          <div
            ...
            className="rounded border border-slate-800 bg-[#121820] p-2.5 space-y-1.5 hover:border-emerald-500/60 hover:bg-[#14201C] transition-all cursor-pointer group"
          >
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-1.5 min-w-0">
                <span className="rounded bg-slate-800 px-1.5 py-0.2 text-[9px] text-slate-300 font-bold">
                  {cite.id}
                </span>
                <strong className="text-slate-100 text-xs truncate group-hover:text-emerald-300 transition-colors">
                  {cite.title}
                </strong>
              </div>
