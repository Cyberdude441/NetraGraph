...
export function CommunityDetection({
  ...
  return (
    <div className="space-y-4 font-sans select-none">
      ...
      <div className="rounded-lg border border-slate-800 bg-[#0E1318] p-4 flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-slate-100 uppercase text-xs">
        ...
        <div className="flex items-center gap-2">
          <span className="rounded bg-[#161D24] px-2.5 py-1 text-[11px] border border-slate-800 text-slate-300">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isSelected
                  ? "border-sky-500 bg-[#141F2B] shadow-xl ring-1 ring-sky-400/50"
                  : "border-slate-800 bg-[#10161E] hover:border-slate-700 hover:bg-[#131B25]"
              )}
            >
              {/* Header */}
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="shrink-0 font-mono text-[10px] font-bold text-slate-300 bg-[#161D24] px-2 py-0.5 rounded border border-slate-800">
                  {comm.memberCount} Entities
                </span>
              </div>

              {/* Metrics Table */}
              <div className="space-y-1.5 font-mono text-[11px] text-slate-400 border-t border-b border-slate-800/80 py-2">
                <div className="flex items-center justify-between">
                  <span>Cluster Density:</span>
                  <strong className="text-slate-200">{comm.density}</strong>
                </div>
                <div className="flex items-center justify-between">
                  <span>Internal Linkages:</span>
                  <strong className="text-slate-200">{comm.internalEdgeCount} Edges</strong>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    ...
                    className="text-sky-300 font-bold hover:underline cursor-pointer truncate max-w-[150px]"
                  >
