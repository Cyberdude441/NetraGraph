...
export function PlaybackControls({
  ...
  return (
    <div className="rounded-lg border border-slate-800 bg-[#0E1318] p-4 select-none font-sans space-y-3 shadow-xl">
      {/* Top Scrubber Line */}
      <div className="flex items-center justify-between font-mono text-[10px] text-slate-400">
        ...
        <span className="text-slate-200 font-bold">{currentDateLabel}</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <button
            onClick={onReset}
            className="p-1.5 rounded border border-slate-800 bg-[#161D24] text-slate-400 hover:text-slate-200 cursor-pointer"
              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : "border border-slate-800 bg-[#161D24] text-slate-400 hover:text-slate-200"
                )}
              >
                {spd}x
              </button>
